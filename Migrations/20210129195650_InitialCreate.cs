...
namespace PerformanceCalculator.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObtainedMark = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.Sql(TeacherSQL.SpDeleteTeacherById());
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(
                name: "Teachers");
            migrationBuilder.Sql(@"DROP PROCEDURE SpGetTeacherById");
            migrationBuilder.Sql(@"DROP PROCEDURE SpDeleteTeacherById");
        }
    }
}
